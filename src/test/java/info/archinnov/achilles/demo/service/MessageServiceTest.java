...
public class MessageServiceTest {
    ...
    public void should_create_message() throws Exception {
        ...
        //When
        service.createMessage("emc2",date,"max_plank","Hey buddy, I've just discovered the secret of the universe: E = mc2");
        ...
        assertThat(row.getString("content")).isEqualTo("Hey buddy, I've just discovered the secret of the universe: E = mc2");
    }
